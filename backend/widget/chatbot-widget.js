 ...
 * 
 * Self-contained — injects its own CSS, creates the chat bubble + window.
...
(function () {
  ...
  const CHATBOT_ID = script?.getAttribute("data-chatbot-id") || script?.getAttribute("data-id") || "";
  const API_BASE =
    ...
    <div id="cb-window">
      <div id="cb-header">
        ...
        <div id="cb-header-info">
          <div id="cb-header-title">AI Assistant</div>
          <div id="cb-header-subtitle">Ask me anything about this site</div>
        </div>
      </div>

      <div id="cb-messages">
        <div class="cb-msg cb-msg-welcome">
